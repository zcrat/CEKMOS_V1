...
final class AlcanceOrdenesServicio
{
    public const BASE = 'ver_presupuestos';
    ...
    public static function puedeAcceder(
        ...
        return $presupuesto->orden_servicio
            && self::puedeAccederOrden($user, $presupuesto->orden_servicio);
    }
}
